...
| `.phase2s/code-index.jsonl` | Semantic code index for `:search` / `phase2s search` / automatic code context injection (SHA-256 + embedding per chunk) | After `phase2s sync` |
