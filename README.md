...
- [Web dashboard](docs/web-dashboard.md) — `phase2s serve`: runs list, run detail, live view (SSE), theme toggle, responsive layout, accessibility, REST API, security model
