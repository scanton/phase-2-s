...
- [Web dashboard](docs/web-dashboard.md) — `phase2s serve`: runs list, run detail, live view (SSE), config editor, theme toggle, responsive layout, accessibility, REST API, security model
...
Phase2S ships fast — most sprints close in a day. The full history of shipped features, from the initial Codex CLI provider through the current v1.70.0 Dashboard Polish Pass + Accessibility, lives in one place:
